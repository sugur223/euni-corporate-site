    ...
    <section id="business" class="p-section -bg">
        <div class="l-container">
            <div class="p-section__head">
                ...
                <p class="c-secDscr">
                    新しい出会いを生み出し、<br class="u-br-sp">今ある関係を深める。<br>
                    IT技術で「つながり」を創り、育てます。
                </p>
            </div>
                    ...
                    <div class="p-ceoMessageCard__content">
                        ...
                        <?php else : ?>
                            <div class="p-ceoMessageCard__text">
                                ...
                                <p>人生には、数々の選択肢がありますが、<br>
                                その選択に最も影響を与えるのが、「人とのつながり」だと、私は信じています。</p>

                                <p>ふとした出会いが、見えなかった道を照らしてくれる。<br>
                                何気ない会話が、自分でも気づかなかった可能性を引き出してくれる。<br>
                                大切な人の言葉が、踏み出せなかった一歩を後押ししてくれる。<br>
                                つながりは、人生を大きく変える力を持っています。</p>

                                <p>あなたの「どう生きるか」という問いに、一緒に向き合いたい。<br>
                                人生の分岐点で、より善い選択を後押しする「きっかけ」になりたい。</p>
                                ...
                                <p class="p-ceoMessageCard__signature">松本 卓</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
