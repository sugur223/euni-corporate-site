                    ...
                    <div class="p-philosophyOrigin__list">
                        <div class="p-philosophyOrigin__item">
                            ...
                            <div class="p-philosophyOrigin__text">
                                ...
                                <p class="p-philosophyOrigin__detail">
                                    一方的な善意ではなく、<br class="u-br-sp">相手を思い、向き合おうとする心。<br>
                        ...
                        <div class="p-philosophyOrigin__item">
                            ...
                            <div class="p-philosophyOrigin__text">
                                ...
                                <p class="p-philosophyOrigin__detail">
                                    ...
                                    ITシステムもAIも、ただの手段。<br>大切なのは、その先にある人と人とのつながり。<br><br>
                                    人と人が出会い、関係性が深まり、可能性が広がる。<br>
                                    あなたの存在が、大切な誰かの人生を拓くきっかけになる。<br>
                                    そのための「接点」「機会」「場」を生み出すことが、<br class="u-br-pc">私たちの使命だと考えています。
                                </p>
                                <p class="p-philosophyOrigin__detail">
                                    技術で人と人をつなぎ、少しでもより善い方向へ。<br>
                        ...
                        <div class="p-philosophyOrigin__item">
                            ...
                            <div class="p-philosophyOrigin__text">
                                ...
                                <p class="p-philosophyOrigin__detail">
                                    人は誰しも、一人では生きていくことはできません。<br class="u-br-pc">
                                    必ず誰かの恩恵を受け、支えられながら生きています。<br><br>
                                    一人ひとりは小さな存在かもしれない。<br>
                                    でも、つながることで「一つ」になり、大きな力になる。<br><br>
                                    誰かから受け取った恩恵を、また別の誰かへ。<br class="u-br-pc">
                                    その循環が広がっていくことで、社会は少しずつ温かくなる。<br>
                                    私たちは、この「つながりの循環」を信じています。
                                </p>
                                <p class="p-philosophyOrigin__detail">
                                    それぞれの道を歩んでいるように見える人々が、実は一つにつながっている。<br>
                                    当たり前になりすぎて、見えづらくなっているつながりを、可視化して育てていく。<br>
                                    それが、Euniの目指す社会です。
                                </p>
                            </div>
                        </div>
