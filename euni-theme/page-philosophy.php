                    ...
                    <div class="p-philosophyOrigin__list">
                        <div class="p-philosophyOrigin__item">
                            ...
                            <div class="p-philosophyOrigin__text">
                                ...
                                <p class="p-philosophyOrigin__detail">
                                    ...
                                    利己と利他を対立させるのではなく、<br class="u-br-sp">両方を大切にするための知恵。<br><br>
                        ...
                        <div class="p-philosophyOrigin__item">
                            ...
                            <div class="p-philosophyOrigin__text">
                                ...
                                <p class="p-philosophyOrigin__detail">
                                    WebサイトもシステムもAIも、ただの手段です。<br class="u-br-pc">大切なのは、その先にある人と人のつながり。<br><br>技術を通じて、温かいつながりが生まれる瞬間を創りたい。<br>
                        ...
                        <div class="p-philosophyOrigin__item">
                            ...
                            <div class="p-philosophyOrigin__text">
                                ...
                                <p class="p-philosophyOrigin__detail">
                                    ...
                                    当たり前になりすぎて見えづらくなっているつながりを、可視化して育てていくこと。<br>
                                    それが、Euniの目指す社会です。
                                </p>
                            </div>
                        </div>
